...
\item
 WEF logo: \url{https://en.wikipedia.orgwiki/World_Economic_Forum}
}
...
\teaser{
  \centering
  \includegraphics[width=50mm,scale=0.5]{wef-image.png}
  \caption{WEF logo from Wikipedia (see url in footnote)}
	\label{fig:teaser}
}
...
The following includes an outline of three specific tasks to be completed via visualizations, relevant literature review, data sources and references.  %\textbf{please leave the copyright statement at the bottom-left of this first page untouched}.
